...
setProperty('dadat.scale.x', 2.4)
setProperty('dadat.scale.y', 2.4)
...
setProperty('bfAt.scale.x', 4.8)
setProperty('bfAt.scale.y', 4.8)
...
flashingband = false
function onUpdate()
setProperty('bfAt.offset.x', 80)
setProperty('bfAt.offset.y', -60)
